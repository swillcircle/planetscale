      ...
      <header className="container relative flex items-center justify-between mx-auto">
        ...
        <nav className="transition absolute z-40 lg:bg-transparent top-12 lg:relative lg:top-0 flex items-center justify-between pointer-events-none opacity-0 lg:opacity-100 lg:pointer-events-auto">
          <div className="flex flex-col font-medium lg:flex-row">
            <a className="mx-[22px] py-2 text-base font-medium  text-gray-50" href="#">Docs</a>
            <a className="mx-[22px] py-2 text-base font-medium text-gray-50" href="#">CLI</a>
            <a className="mx-[22px] py-2 text-base font-medium text-gray-50" href="#">Pricing</a>
            <a className="mx-[22px] py-2 text-base font-medium text-gray-50" href="#">Enterprise</a>
            <a className="ml-[22px] mr-[28px]  py-2 text-base font-medium text-gray-50" href="#">Blog</a>
          </div>
